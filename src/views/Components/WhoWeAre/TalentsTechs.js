            ...
            <div className="container">
                ...
                <div className="custom-container">
                    <div className="background-card position-relative mx-auto">
                        ...
                        <h3>Rejoindre EFSENS c'est travailler en synergie pour répondre et imaginer les technologies de demain.  Chez Efisens, notre environnement de travail est collaboratif, moderne et dynamique…<br />
