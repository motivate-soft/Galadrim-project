...
export default function WhyDoIt() {
    return (
        <div className="section why-do-it">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-4 mb-4 offset-lg-2">
                        <div className="who-image-card top-rounded">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="whydoit-card top-rounded bottom-rounded">
                ...
                <div className="row">
                    <div className="col-lg-4 mb-4 offset-lg-2">
                        ...
                        <div className="whydoit-card bottom-rounded">
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="who-image-card bottom-rounded">
